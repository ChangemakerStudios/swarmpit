...
{
    public static Models.SwarmService ToSwarmService(
        ...
        IList<NetworkResponse>? networks = null)
    {
        ...
        return new Models.SwarmService
        {
            Id = svc.ID ?? "",
            ...
            Agent = agentStr == "true",
            Status = new Models.ServiceStatus
            {
    ...
    private static Models.ServiceHealthcheck MapHealthcheck(HealthConfig? healthcheck)
    {
        if (healthcheck == null) return new Models.ServiceHealthcheck();

        return new Models.ServiceHealthcheck
        {
